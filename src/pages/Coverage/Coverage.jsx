...
const branchData = [
  ...
  },
  {
    ...
    // (Note: Ensure the full 64 objects are included in your actual file)
];
...
const Coverage = () => {
    ...
    return (
        <section className="py-20 bg-gray-50 px-4">
            <div className="max-w-7xl mx-auto bg-white rounded-[40px] shadow-sm p-10 md:p-16 border border-gray-100" data-aos="fade-up">
                
                {/* Header Section */}
                <div className="mb-10">
                    <h2 className="text-4xl font-bold text-[#052c2c] mb-8">
                        We are available in {branchData.length} districts
                    </h2>
                    
                    {/* Search Bar */}
                    <div className="relative max-w-md">
                        <div className="flex items-center bg-[#f3f4f6] rounded-full px-5 py-2 border border-transparent focus-within:border-[#052c2c]/20 transition-all">
                            ...
                            />
                            <button className="bg-[#bef264] hover:bg-[#a3d94d] text-[#052c2c] font-bold px-6 py-2 rounded-full transition-colors ml-2">
                                Search
                            </button>
                        </div>
                    </div>
                ...
                <div className="border-t border-gray-100 pt-10">
                    <h3 className="text-2xl font-bold text-[#052c2c] mb-6">
                        We deliver almost all over Bangladesh
                    </h3>

                    {/* Map Container */}
                    <div className="h-150 w-full rounded-3xl overflow-hidden border-4 border-white shadow-lg z-0">
                        <MapContainer 
                                ...
                                >
                                    <Popup>
                                        <div className="font-urbanist">
                                            <h4 className="font-bold text-[#052c2c]">{branch.district} Branch</h4>
                                            <p className="text-xs text-gray-600 mb-2">Region: {branch.region}</p>
                                            <div className="flex flex-wrap gap-1">
                                                {branch.covered_area.map((area, i) => (
                                                    <span key={i} className="bg-gray-100 px-2 py-0.5 rounded text-[10px]">
                                                        {area}
                                                    </span>
                                                ))}
                                            </div>
